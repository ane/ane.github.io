...
Ivar Jacobson, Martin Griss and Patrik Jonsson (Addison-Wesley, 1997). A
recurring theme in working with software product engineering is the idea of
_software product lines_. For an introduction to the topic I recommend _Software
Product Lines: Practices and Patterns_ by Klaus Pohl, Günter Böckle and Frank
J. van der Linden (Springer, 2005) and _Software Product Line Engineering:
Foundations, Principles and Techniques_ by Paul Clements and Linda Northrop
(Addison-Wesley, 2002).
